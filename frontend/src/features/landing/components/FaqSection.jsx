...
export default function FaqSection() {
  ...
  return (
    <section id="faq" ref={containerRef} className="py-24 px-6 bg-[#FFFFFF]">
      <div className="max-w-3xl mx-auto">
        ...
        <Accordion type="single" collapsible className="faq-accordion space-y-4 shadow-[#bc1313]/10 shadow-xl">
          {/* FAQ 1 */}
          <AccordionItem value="item-1" className="faq-item opacity-0 bg-white border border-[#bc1313]/20 rounded-2xl px-6 transition-all hover:border-[#bc1313]/50 shadow-sm">
            <AccordionTrigger className="hover:text-[#bc1313] text-[#430202] py-6 text-left text-base font-medium transition-colors">
              What is ASPIRE and how does it work?
            </AccordionTrigger>
            <AccordionContent className="text-[#430202]/80 pb-6 leading-relaxed">
          ...
          {/* FAQ 2 */}
          <AccordionItem value="item-2" className="faq-item opacity-0 bg-white border border-[#bc1313]/20 rounded-2xl px-6 transition-all hover:border-[#bc1313]/50 shadow-sm">
            <AccordionTrigger className="hover:text-[#bc1313] text-[#430202] py-6 text-left text-base font-medium transition-colors">
          ...
          {/* FAQ 3 */}
          <AccordionItem value="item-3" className="faq-item opacity-0 bg-white border border-[#bc1313]/20 rounded-2xl px-6 transition-all hover:border-[#bc1313]/50 shadow-sm">
            <AccordionTrigger className="hover:text-[#bc1313] text-[#430202] py-6 text-left text-base font-medium transition-colors">
          ...
          {/* FAQ 4 */}
          <AccordionItem value="item-4" className="faq-item opacity-0 bg-white border border-[#bc1313]/20 rounded-2xl px-6 transition-all hover:border-[#bc1313]/50 shadow-sm">
            <AccordionTrigger className="hover:text-[#bc1313] text-[#430202] py-6 text-left text-base font-medium transition-colors">
          ...
          {/* FAQ 5 */}
          <AccordionItem value="item-5" className="faq-item opacity-0 bg-white border border-[#bc1313]/20 rounded-2xl px-6 transition-all hover:border-[#bc1313]/50 shadow-sm">
            <AccordionTrigger className="hover:text-[#bc1313] text-[#430202] py-6 text-left text-base font-medium transition-colors">
