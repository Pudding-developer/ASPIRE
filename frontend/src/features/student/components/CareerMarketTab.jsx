  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
      ...
      <div className="bg-white border border-gray-100 rounded-xl p-3.5">
        <p className="text-[8px] font-bold uppercase tracking-[0.1em] text-gray-400 mb-1.5">Job Demand Growth</p>
      ...
      <div className="bg-white border border-gray-100 rounded-xl p-3.5">
        <p className="text-[8px] font-bold uppercase tracking-[0.1em] text-gray-400 mb-1.5">Average Monthly Salary</p>
      ...
      <div className="bg-[#7a0e0e] rounded-xl p-3.5 text-white">
        <p className="text-[8px] font-bold uppercase tracking-[0.1em] text-white/40 mb-1.5">Market Outlook</p>
      ...
      {/* Median Tenure */}
      <div className="bg-white border border-gray-100 rounded-xl p-3.5">
        <p className="text-[8px] font-bold uppercase tracking-[0.1em] text-gray-400 mb-1.5">Median Tenure</p>
      ...
      {/* Top Locations */}
      <div className="bg-white border border-gray-100 rounded-xl p-3.5">
        <p className="text-[8px] font-bold uppercase tracking-[0.1em] text-gray-400 mb-1.5">Top PH Locations</p>
        <p className="text-[11px] text-gray-500 leading-relaxed mt-1.5">{market.locations}</p>
      </div>

      {/* Readiness Score */}
      <div className="bg-white border border-gray-100 rounded-xl p-3.5">
        <p className="text-[8px] font-bold uppercase tracking-[0.1em] text-gray-400 mb-1.5">Your Readiness Score</p>
