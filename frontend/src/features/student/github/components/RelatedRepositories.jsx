        ...
        <div className="grid md:grid-cols-2 gap-4">
          {related.map(repo => (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="border border-[#30363d] bg-[#0d1117] rounded-xl p-4 flex flex-col gap-2 hover:border-[#8b949e] transition-colors relative group cursor-pointer"
            >
              <div className="flex items-start justify-between gap-2">
                <span className="text-[14px] font-semibold text-[#58a6ff] hover:underline leading-tight truncate pr-6">
                  {repo.full_name}
                </span>
                <span className="absolute right-4 top-4 text-[#8b949e] opacity-0 group-hover:opacity-100 transition-opacity hover:text-[#c9d1d9]">
