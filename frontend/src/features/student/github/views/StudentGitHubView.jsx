...
import { StudentGitHubSkeleton } from '../../shared/StudentPageSkeletons';
        ...
        <div className="lg:col-span-2">
          <div className="bg-[#161b22] border border-[#30363d] rounded-2xl p-6">
            ...
            {repos.length === 0 ? (
              ...
              <div className="grid md:grid-cols-2 gap-4 max-h-160 overflow-y-auto pr-1"
                ...
                {repos.map(repo => (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="block border border-[#30363d] bg-[#0d1117] rounded-xl p-4 flex flex-col gap-2 hover:border-[#8b949e] transition-colors cursor-pointer"
                  >

                    {/* Title row */}
                    <div className="flex items-start justify-between gap-2">
                      <span className="text-[14px] font-semibold text-[#58a6ff] hover:underline leading-tight">
                        {repo.repo_name}
                      </span>
